...
SET ANSI_NULLS ON
GO
CREATE view [sascdm].[vw_rpt_contact_history] as
	select ssb_crmsystem_contact_id
		...
		from sascdm.vw_em_response_history rsp
			inner join sascdm.ci_cell_package cp
			on cp.cell_package_sk = rsp.cell_package_sk
			inner join sascdm.ci_campaign_ext ce
