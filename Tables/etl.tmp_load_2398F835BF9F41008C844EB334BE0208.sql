CREATE TABLE [etl].[tmp_load_2398F835BF9F41008C844EB334BE0208]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_2398F835BF9F41008C844EB334BE0208_ss] ON [etl].[tmp_load_2398F835BF9F41008C844EB334BE0208] ([SourceSystem], [SSID])
GO
