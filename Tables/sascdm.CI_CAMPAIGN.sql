CREATE TABLE [sascdm].[CI_CAMPAIGN]
(
...
GO
ALTER TABLE [sascdm].[CI_CAMPAIGN] ADD CONSTRAINT [CAMP_PK] PRIMARY KEY CLUSTERED  ([CAMPAIGN_SK])
GO
ALTER TABLE [sascdm].[CI_CAMPAIGN] WITH NOCHECK ADD CONSTRAINT [CAMP_FK1] FOREIGN KEY ([CAMPAIGN_STATUS_CD]) REFERENCES [sascdm].[CI_CAMPAIGN_STATUS] ([CAMPAIGN_STATUS_CD])
GO
ALTER TABLE [sascdm].[CI_CAMPAIGN] WITH NOCHECK ADD CONSTRAINT [CAMP_FK2] FOREIGN KEY ([CAMPAIGN_TYPE_CD]) REFERENCES [sascdm].[CI_CAMPAIGN_TYPE] ([CAMPAIGN_TYPE_CD])
GO
ALTER TABLE [sascdm].[CI_CAMPAIGN] WITH NOCHECK ADD CONSTRAINT [CAMP_FK3] FOREIGN KEY ([CAMPAIGN_GROUP_SK]) REFERENCES [sascdm].[CI_CAMPAIGN_GROUP] ([CAMPAIGN_GROUP_SK])
GO
