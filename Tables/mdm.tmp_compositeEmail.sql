CREATE TABLE [mdm].[tmp_compositeEmail]
(
[DimEmailID] [int] NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomerid] ON [mdm].[tmp_compositeEmail] ([DimCustomerId]) INCLUDE ([DimEmailID])
GO
CREATE NONCLUSTERED INDEX [IX_tmp_compositeEmail] ON [mdm].[tmp_compositeEmail] ([DimEmailID])
GO
