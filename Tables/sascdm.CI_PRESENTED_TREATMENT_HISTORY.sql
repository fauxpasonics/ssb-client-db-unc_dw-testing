CREATE TABLE [sascdm].[CI_PRESENTED_TREATMENT_HISTORY]
(
...
GO
ALTER TABLE [sascdm].[CI_PRESENTED_TREATMENT_HISTORY] ADD CONSTRAINT [PRE_TRT_HST_PK] PRIMARY KEY CLUSTERED  ([CELL_PACKAGE_SK], [SSB_CRMSYSTEM_CONTACT_ID], [TREATMENT_SK], [TREATMENT_HASH_VAL], [PRESENTED_TREATMENT_HIST_DTTM])
GO
