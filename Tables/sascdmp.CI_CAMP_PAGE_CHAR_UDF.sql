CREATE TABLE [sascdmp].[CI_CAMP_PAGE_CHAR_UDF]
(
...
GO
ALTER TABLE [sascdmp].[CI_CAMP_PAGE_CHAR_UDF] ADD CONSTRAINT [CP_CH_UDF_PK] PRIMARY KEY CLUSTERED  ([CAMPAIGN_SK], [PAGE_NM], [CHAR_UDF_NM])
GO
ALTER TABLE [sascdmp].[CI_CAMP_PAGE_CHAR_UDF] ADD CONSTRAINT [CP_CH_UDF_FK1] FOREIGN KEY ([CAMPAIGN_SK], [PAGE_NM]) REFERENCES [sascdmp].[CI_CAMP_PAGE] ([CAMPAIGN_SK], [PAGE_NM])
GO
