CREATE TABLE [etl].[tmp_load_B69238A9A2F34BBA8136C898A90FE6E3]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_B69238A9A2F34BBA8136C898A90FE6E3_ss] ON [etl].[tmp_load_B69238A9A2F34BBA8136C898A90FE6E3] ([SourceSystem], [SSID])
GO
