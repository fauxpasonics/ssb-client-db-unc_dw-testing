CREATE TABLE [etl].[tmp_load_0FCC0A1D6CE7491780F204D4098B1A5A]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_0FCC0A1D6CE7491780F204D4098B1A5A_ss] ON [etl].[tmp_load_0FCC0A1D6CE7491780F204D4098B1A5A] ([SourceSystem], [SSID])
GO
