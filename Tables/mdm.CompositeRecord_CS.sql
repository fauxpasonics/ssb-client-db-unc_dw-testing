CREATE TABLE [mdm].[CompositeRecord_CS]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_CompositeRecord_CS_IsDeleted_Include] ON [mdm].[CompositeRecord_CS] ([IsDeleted]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID], [SSID])
GO
CREATE NONCLUSTERED INDEX [ix_compositeRecord_CS_SSB_CRMSYSTEM_CONTACT_ID] ON [mdm].[CompositeRecord_CS] ([SSB_CRMSYSTEM_CONTACT_ID]) INCLUDE ([IsDeleted])
GO
