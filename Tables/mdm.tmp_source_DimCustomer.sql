CREATE TABLE [mdm].[tmp_source_DimCustomer]
(
...
GO
CREATE CLUSTERED INDEX [ix_tmp_source_dimcustomer_dimcustomerid] ON [mdm].[tmp_source_DimCustomer] ([DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [ix_tmp_source_dimcustomer_ssid_sourcesystem] ON [mdm].[tmp_source_DimCustomer] ([SSID], [SourceSystem])
GO
