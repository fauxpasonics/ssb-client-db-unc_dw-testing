CREATE TABLE [stg].[Sync_temp_mdm_CompositeRecord]
(
...
GO
ALTER TABLE [stg].[Sync_temp_mdm_CompositeRecord] ADD CONSTRAINT [PK__Sync_tem__19364FD2E131ADF9] PRIMARY KEY CLUSTERED  ([ETL_Sync_Id])
GO
