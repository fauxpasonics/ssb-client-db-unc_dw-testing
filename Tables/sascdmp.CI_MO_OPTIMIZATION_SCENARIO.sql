CREATE TABLE [sascdmp].[CI_MO_OPTIMIZATION_SCENARIO]
(
...
GO
ALTER TABLE [sascdmp].[CI_MO_OPTIMIZATION_SCENARIO] ADD CONSTRAINT [MO_OPT_SCN_PK] PRIMARY KEY CLUSTERED  ([MO_OPT_SCENARIO_SK])
GO
