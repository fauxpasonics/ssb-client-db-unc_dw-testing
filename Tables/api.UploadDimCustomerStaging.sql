...
[RecordCreateDate] [datetime] NULL CONSTRAINT [DF__UploadDim__Recor__7FEAFD3E] DEFAULT (getdate()),
[Processed] [bit] NULL CONSTRAINT [DF__UploadDim__Proce__00DF2177] DEFAULT ((0)),
...
[IsDeleted] [bit] NULL CONSTRAINT [DF__UploadDim__IsDel__513E5A73] DEFAULT ((0))
)
GO
