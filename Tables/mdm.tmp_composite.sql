CREATE TABLE [mdm].[tmp_composite]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomerid] ON [mdm].[tmp_composite] ([DimCustomerId]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_tmp_composite] ON [mdm].[tmp_composite] ([SSB_CRMSYSTEM_CONTACT_ID])
GO
