CREATE TABLE [stg].[FactTicketSales_Test]
(
...
GO
ALTER TABLE [stg].[FactTicketSales_Test] ADD CONSTRAINT [FK_PlanTypeId_Test] FOREIGN KEY ([DimPlanTypeId]) REFERENCES [dbo].[DimPlanType] ([DimPlanTypeId])
GO
