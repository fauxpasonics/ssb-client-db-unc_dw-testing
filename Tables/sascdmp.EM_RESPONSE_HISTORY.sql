CREATE TABLE [sascdmp].[EM_RESPONSE_HISTORY]
(
...
GO
ALTER TABLE [sascdmp].[EM_RESPONSE_HISTORY] ADD CONSTRAINT [EM_RESP_HIST_PK] PRIMARY KEY CLUSTERED  ([em_sendid], [ssb_crmsystem_contact_id], [response_dttm], [eventtype], [em_sendurlid])
GO
