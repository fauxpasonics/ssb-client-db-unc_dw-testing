CREATE TABLE [etl].[tmp_load_D3D94577C79B4E7E8ACA8F52F95CB9B2]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_D3D94577C79B4E7E8ACA8F52F95CB9B2_ss] ON [etl].[tmp_load_D3D94577C79B4E7E8ACA8F52F95CB9B2] ([SourceSystem], [SSID])
GO
