...
GO
CREATE NONCLUSTERED INDEX [IX_IsDeleted_INCLUDE] ON [mdm].[compositerecord] ([IsDeleted]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
CREATE NONCLUSTERED INDEX [IX_dimcustomerssbid_isdeleted_include] ON [mdm].[compositerecord] ([IsDeleted]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID], [SSID])
GO
...
GO
CREATE NONCLUSTERED INDEX [idx_CompositeRecord_SSBID] ON [mdm].[compositerecord] ([SSB_CRMSYSTEM_CONTACT_ID])
GO
