...
CREATE PROCEDURE [etl].[BB_Load_DimCustomer]
...
SELECT * 
INTO #tmpETL 
FROM etl.[vw_BB_Load_DimCustomer]
...
THEN UPDATE SET 
	myTarget.PhonePrimaryDNC = mySource.DoNotPhone
	, myTarget.PhoneHomeDNC = mySource.DoNotPhone
	, myTarget.PhoneCellDNC = mySource.DoNotPhone
	, myTarget.PhoneBusinessDNC = mySource.DoNotPhone
