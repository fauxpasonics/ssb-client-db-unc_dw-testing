...
SELECT trans.CUSTOMER, trans.SEASON, trans.E_ITEM, MIN(trans.[DATE]) MinPaymentDate
INTO #MinPaymentDate
FROM dbo.TK_TRANS_ITEM_EVENT trans (NOLOCK)
GROUP BY trans.CUSTOMER, trans.SEASON, trans.E_ITEM
...
, tkODet.ORIGTS_USER, tkODet.ORIGTS_DATETIME, tkODet.I_PKG, tkODet.E_SBLS_1, tkODet.LAST_USER, tkODet.I_PL, tkODet.I_FPRICE, tkODet.SOURCE_ID, tkODet.I_PRICE,  tkODet.I_DAMT, tkODet.I_CPRICE, tkODet.PROMO, minpayment.MinPaymentDate
...
LEFT OUTER JOIN #MinPaymentDate minpayment
	ON minpayment.CUSTOMER = tkODet.CUSTOMER
	AND minpayment.SEASON = tkODet.SEASON
	AND minpayment.E_ITEM = tkODet.ITEM
...
, CASE WHEN tkODet.MinPaymentDate < tkODet.I_DATE THEN tkOdet.MinPaymentDate ELSE tkOdet.I_DATE END AS I_DATE
